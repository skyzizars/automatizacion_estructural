...
-%
4}%
\textit{Peso sísmico (ETABS)}&\textbf{Ps (Ton)}&\multicolumn{2}{c|}{369.21}\\%
\cline{2%
-%
4}%
...
-%
4}%
\textit{Cortante estática (Art.28.2)}&\textbf{V (ton)}&\cellcolor[rgb]{ 1,  .949,  .8}\textcolor[rgb]{ 1,  0,  0}{\textbf{81.78}}&\cellcolor[rgb]{ 1,  .949,  .8}\textcolor[rgb]{ 1,  0,  0}{\textbf{93.46}}\\%
\cline{2%
-%
4}%
...
\midrule
Story3 & 90.122 & 12.200 & 12.200 & 12.200 & 1099.494 & 1099.494 & 0.368 & 0.368 & 30.133 & 34.437 \\
Story2 & 135.809 & 8.600 & 8.600 & 8.600 & 1167.954 & 1167.954 & 0.391 & 0.391 & 32.009 & 36.581 \\
Story1 & 143.284 & 5.000 & 5.000 & 5.000 & 716.420 & 716.420 & 0.240 & 0.240 & 19.634 & 22.439 \\
\bottomrule
\end{tabular}
%
\end{table}
...
\cline{2-3}%
\textit{Desplazamiento máximo en X} & \textbf{$\Delta_x$} & {1.57} & {cm} \\%
\cline{2-3}%
\textit{Desplazamiento máximo en Y} & \textbf{$\Delta_y$} & {0.72} & {cm} \\%
\cline{2-3}%
\textit{Separación del limite de propiedad X} & \textbf{2/3$\Delta_{x}$} & {1.04} & {cm} \\%
\cline{2-3}%
\textit{Separación del limite de propiedad Y} & \textbf{2/3$\Delta_{y}$} & {0.48} & {cm} \\%
\cline{2-3}%
\end{tabular}%
\label{tab:junta_sis}%
\end{table}
